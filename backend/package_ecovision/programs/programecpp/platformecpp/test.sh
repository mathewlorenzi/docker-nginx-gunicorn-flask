...
CAMID=$1
if [ "$CAMID" == "" ]; then
    echo "camid as first arg not provided"
    exit 1
fi

./../../../build/bin/platformecpp -subsize 0 -control control2d.txt -stamp_filename_from_mmap -camidname $CAMID -motionwindow 2 -context2dec LOCAL -directory /home/ecorvee/Projects/WEBAPP/docker-nginx-gunicorn-flask/database_clients_camera
