...
./../../../build/bin/platformecpp -subsize 0 -control control2d.txt -http_client_to_flask_server -camidname paulo9 -host http://127.0.0.1 -port 5000 -motionwindow 2 -context2dec LOCAL -fantagaugedim 70
